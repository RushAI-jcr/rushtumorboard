...
The glob pattern matches UUID-formatted folder names (e.g., `8048FA31-B2AB-4928-A341-3D00679F368A`) while preserving synthetic test patients (`patient_gyn_001`, `patient_gyn_002`, `patient_4`).
